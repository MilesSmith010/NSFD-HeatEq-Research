%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  NSFD Schemes ID #4 using Forward Difference Method for Heat Equation
%  Explicit Equation:   
...
%
%   ID#4 Unity Approximation:
%         1 = U(j,i+1)+U(j,i-1))/(2U(j,i)
%
%         U(j+1,k) = (1-2R)*U(j,k) * [U(j,i+1)+U(j,i-1))/(2U(j,i)] + R(U(j,k+1) + U(j,k-1))
%
%                  = U(j,i+1)+U(j,i-1))/2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
